#
#  Be sure to run `pod spec lint ImageCroper.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "ImageCroper"
  s.version      = "1.0"
  s.summary      = "ImageCroper is used to crop images."
...
#  s.description  = <<-DESC
  ...
  s.source_files  = "ImageCroping/Cropper/*.{h,m}"
  s.exclude_files = "ImageCroping/Cropper/KICropImageView.m"
